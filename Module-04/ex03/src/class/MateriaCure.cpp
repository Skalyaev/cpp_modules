#include "../../include/class/MateriaCure.hpp"

MateriaCure::MateriaCure() : AMateria::AMateria("cure")
{
        std::cout << "[ DEFAULT ][ " << this << " ] MateriaCure constructor called" << std::endl;
}

MateriaCure::MateriaCure(const MateriaCure &src) : AMateria::AMateria(src)
{
