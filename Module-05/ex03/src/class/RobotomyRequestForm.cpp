...
RobotomyRequestForm::RobotomyRequestForm() : AForm::AForm("RobotomyRequestForm", "UNDEFINED", 72, 45)
{
...
RobotomyRequestForm::RobotomyRequestForm(const std::string &str) : AForm::AForm("RobotomyRequestForm", str, 72, 45)
{
