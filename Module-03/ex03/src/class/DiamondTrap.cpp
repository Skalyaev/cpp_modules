#include "../../include/class/DiamondTrap.hpp"

DiamondTrap::DiamondTrap() : ClapTrap::ClapTrap("UNDEFINED_clap_name"),
...
DiamondTrap::DiamondTrap(const DiamondTrap &src) : ClapTrap::ClapTrap(src),
...
DiamondTrap::DiamondTrap(const std::string &str) : ClapTrap::ClapTrap(str + "_clap_name"),
