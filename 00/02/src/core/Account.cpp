...
Account::Account() : _accountIndex(this->getNbAccounts()), _amount(0), _nbDeposits(0), _nbWithdrawals(0)
{
        this->_nbAccounts++;
        this->_accountIndex++;
...
Account::Account(int initial_deposit) : _accountIndex(this->getNbAccounts() - 1), _amount(initial_deposit), _nbDeposits(0), _nbWithdrawals(0)
{
...
void Account::_displayTimestamp()
{
        ...
        std::cout << "[" << std::put_time(Time, "%Y%m%d") << "_" << std::put_time(Time, "%H%M%S") << "] ";
}
