...
PresidentialPardonForm::PresidentialPardonForm() : AForm::AForm("PresidentialPardonForm", "UNDEFINED", 25, 5)
{
...
PresidentialPardonForm::PresidentialPardonForm(const std::string &str) : AForm::AForm("PresidentialPardonForm", str, 25, 5)
{
