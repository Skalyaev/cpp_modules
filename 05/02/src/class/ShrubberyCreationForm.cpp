...
ShrubberyCreationForm::ShrubberyCreationForm() : AForm::AForm("ShrubberyCreationForm", "UNDEFINED", 145, 137)
{
...
ShrubberyCreationForm::ShrubberyCreationForm(const std::string &str) : AForm::AForm("ShrubberyCreationForm", str, 145, 137)
{
