...
Fixed getArea(const Fixed *norm)
{
        ...
        delete[] norm;
        std::cout << "Area is " << Fixed(ftSqrt(a.toFloat() * b.toFloat() * c.toFloat() * d.toFloat())) << std::endl
                  << std::endl;
...
{
        std::cout << "[ Managing triangle A(" << a << ") | B(" << b << ") | C(" << c << ") & point(" << point << ") ]" << std::endl
                  << std::endl;

        Fixed diff = getArea(newTriangle(a, b, c)) - getArea(newTriangle(a, b, point)) - getArea(newTriangle(a, c, point)) - getArea(newTriangle(c, b, point));
